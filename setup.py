...
setup(
  ...
  version = '7.0',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/hannahbus/hbussi/archive/refs/tags/v7.0.tar.gz',    # I explain this later on
